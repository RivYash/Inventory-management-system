...
<tbody>
   <tr>
      <td colspan="9" style="text-align:center; font-size: 25px;">TAX INVOICE</td>
      <tr>
   ...
   <tr>
                  ...
                  <tr>
                     <td style="width: 123px;text-align: center;border-left: 1px solid black;border-bottom: 1px solid black;-webkit-print-color-adjust: exact;">S.N.</td>
                     ...
                     <td style="width: 150px;text-align: center;border-top-style: solid;border-left: 1px solid black;border-bottom-style: solid;border-top-width: thin;border-right-width: thin;border-bottom-width: thin;border-top-color: black;border-right-color: black;border-bottom-color: black;-webkit-print-color-adjust: exact;">Qty.</td>
                     ...
                     <td style="width: 150px;text-align: center;border-top-style: solid;border-left: 1px solid black;border-bottom-style: solid;border-top-width: thin;border-right-width: thin;border-bottom-width: thin;border-top-color: black;border-right-color: black;border-bottom-color: black;-webkit-print-color-adjust: exact;">GSTN Rate</td>
                     <td style="width: 150px;text-align: center;border-top-style: solid;border-left: 1px solid black;border-bottom-style: solid;border-top-width: thin;border-right-width: thin;border-bottom-width: thin;border-top-color: black;border-right-color: black;border-bottom-color: black;-webkit-print-color-adjust: exact;">GSTN Amount</td>
            ...
            while($row = $orderItemResult->fetch_array()) {  
               ...
               $table .= '<tr>
                     <td style="border-left: 1px solid black;height: 27px;">'.$x.'</td>
                     ...
                     <td style="border-left: 1px solid black;height: 27px;">18%</td>
                     <td style="border-left: 1px solid black;height: 27px;">'.$tgst.'</td>
                     <td style="border-left: 1px solid black;height: 27px;">'.$t_tgst.'</td>
                  </tr>';
            $x++;
            } // /while
                $table.= '
                  <tr style=" border-bottom: 1px solid black;">
                     <td style="border-left: 1px solid black;height: 27px;border-bottom: 1px solid black;border-top: 1px solid black;"></td>
                     <td style="border-left: 1px solid black;height: 27px;border-bottom: 1px solid black;border-top: 1px solid black;"></td>
                     <td style="border-left: 1px solid black;height: 27px;border-bottom: 1px solid black;border-top: 1px solid black;"></td>
                     <td style="border-left: 1px solid black;height: 27px;border-bottom: 1px solid black;border-top: 1px solid black;"></td>                     
                     <td style="border-left: 1px solid black;height: 27px;border-bottom: 1px solid black;border-top: 1px solid black;"></td>  
                     <td style="border-left: 1px solid black;height: 27px;border-bottom: 1px solid black;border-top: 1px solid black;">Total</td> 
                     <td style="border-left: 1px solid black;height: 27px;border-bottom: 1px solid black;border-top: 1px solid black;">'.$total.'</td> 
                  </tr>
                  <tr style="border-bottom: 1px solid black;">
                     <td style="border-left: 1px solid black;height: 40px;border-top: 1px solid black;"></td>
                     <td style="border-left: 1px solid black;height: 40px;border-top: 1px solid black;"></td>                   
                     <td colspan="3" style="border-left: 1px solid black;height: 40px;font-weight: 600;border-top: 1px solid black;">Grand Total</td> 
                     <td colspan="4" style="border-left: 1px solid black;height: 40px;font-weight: 600;border-top: 1px solid black;">'.round($total).'.00/-</td> 
                  </tr>
                  <tr style="border-bottom: 1px solid black;">
